<div component="pagination" class="pagination-container mt-3{{{ if !pagination.pages.length }}} hidden{{{ end }}}">
	...
	{{{ if !template.topic }}}
		<ul class="pagination pagination-sm hidden-md hidden-lg justify-content-center mt-3" style="overflow-x: hidden;">
	...
	<ul class="pagination pagination-sm hidden-md hidden-lg justify-content-center">
		...
		<li class="page-item previous{{{ if !pagination.prev.active }}} disabled{{{ end }}}" style="width: 77px;text-align: center;">
			<a class="page-link fw-secondary"  href="?{pagination.prev.qs}" data-page="{pagination.prev.page}"><i class="fa fa-chevron-left"></i> </a>
		</li>

		<li component="pagination/select-page" class="page-item page select-page" style="pointer-events: none;">
			<a class="page-link fw-secondary"  href="#">{pagination.currentPage} / {pagination.pageCount}</a>
		</li>

		<li class="page-item next{{{ if !pagination.next.active }}} disabled{{{ end }}}" style="width: 77px;text-align: center;">
